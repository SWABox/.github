...
- **[SWABox](https://github.com/SWABox/SWABox/)** - SWABox 应用主仓库
- [SWABox-site](https://github.com/SWABox/SWABox-site) - SWABox 网站仓库
...
| 下载渠道  | **🚀 正式版**<br/>[![正式版](https://img.shields.io/github/v/release/SWABox/SWABox?style=flat-square&color=%22c55d&label=)](https://github.com/SWABox/SWABox/releases/latest) | 
| :-------: | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
|  GitHub   |                                                            [**下载**](https://github.com/ClassIsland/ClassIsland/releases/latest)                                                                                                   
...
- [📚 SWABox 用户手册](https://github.com/SWABox/SWABox/blob/master/docs/user_manual.md)

您也可以加入这些社区**寻求帮助**：

[![GitHub Issues](https://img.shields.io/github/issues-search/SWABox/SWABox?query=is%3Aopen&style=flat-square&logo=github&label=Issues&color=%22c55d)](https://github.com/SWABox/SWABox/issues)
[![GitHub Discussions](https://img.shields.io/github/discussions/SWABox/SWABox?style=flat-square&logo=Github&label=Discussions)](https://github.com/SWABox/SWABox/discussions)
